...
"""
instruqt-xblock documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'instruqt-xblock',  # Repo name
...
#
# html_title = 'instruqt-xblock v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'XBlock to embed Instruqt track in Open edX',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'instruqtxblock'),
                os.path.join(root_path, 'instruqtxblock/migrations')])
